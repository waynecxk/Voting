...
Used to start an interactive JavaScript console connected to your local Hardhat network

Purpose: 
    Starts a hardhat node if not already running
    Connect to local network
    Load contract artifacts

Expected output: Welcome to Node.js
